...
window.Quran = (function(){
    ...
    try {
      ...
      ayahs.forEach((a, i) => {
        ...
        card.innerHTML =
          ...
          '<button class="btn-icon play-btn" title="Écouter">' + Icon("play") + '</button></div>' +
      ...
      cont.innerHTML = '<div class="loading">' + Icon("alert") + ' Impossible de charger la sourate.<br><small>Vérifie ta connexion internet puis réessaie.</small></div>';
    }
  }
  ...
  function markPlaying(i){
    ...
    el("btn-play-all").innerHTML = autoplayIdx >= 0 ? Icon("pause") + "Pause" : Icon("play") + "Tout écouter";
  }
  function playOne(i){
