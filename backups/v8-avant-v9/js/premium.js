...
window.Premium = (function(){
  ...
  async function nativeBuy(){
    ...
    try {
      ...
      if (isActive()) { closePaywall(); alert("Merci ! Premium activé."); }
    } catch(e){
  ...
  function renderSupport(){
    ...
    box.innerHTML =
      '<h3>' + Icon("heart") + 'Soutenir Iqra Academy</h3>' +
      ...
      '<a class="btn small" href="' + url + '" target="_blank" rel="noopener">' + Icon("coffee") + 'Faire un don</a>';
  }
