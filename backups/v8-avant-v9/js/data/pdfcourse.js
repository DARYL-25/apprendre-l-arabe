...
{ key:"pdf-allah", title:"Bon à savoir : Allah et tâ marbouta", words:[
  { ar:"هُوَ اللَّهُ",  ph:"houwa-llâhou" }, { ar:"بِاللَّهِ",    ph:"bi-llâhi" },
  { ar:"مِنَ اللَّهِ",  ph:"mina-llâhi" },   { ar:"قُلِ اللَّهُ", ph:"qouli-llâhou" },
  { ar:"وَاللَّهِ",     ph:"wa-llâhi" },     { ar:"رِحْلَةٌ",   ph:"rihlatoun" },
...
{ key:"pdf-recap", title:"Récapitulatif : mots du Coran", words:[
  { ar:"بِسْمِ اللَّهِ",     ph:"bismi-llâhi" },      { ar:"الرَّحْمَٰنِ",    ph:"ar-rahmâni" },
  { ar:"الرَّحِيمِ",       ph:"ar-rahîmi" },        { ar:"فَأَغْشَيْنَاهُمْ", ph:"fa-aghshaynâhoum" },
  { ar:"أَأَنْذَرْتَهُمْ",  ph:"a-andhartahoum" },   { ar:"آبَاؤُهُمْ",     ph:"âbâ'ouhoum" },
