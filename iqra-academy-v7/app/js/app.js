...
window.App = (function(){
  ...
  function renderHome(){
    ...
    inf.innerHTML =
      ...
      (Premium.isActive()
        ? '<p class="inf-quota">♾️ Premium : illimité</p>'
  ...
  function renderProfile(){
    ...
    if (pb) {
      pb.innerHTML = Premium.isActive()
        ? '<h3>♾️ Premium</h3><p class="acct-note">Merci pour ton soutien ! Entraînement infini illimité.</p>'
        : '<h3>♾️ Premium</h3><p class="acct-note">Entraînement infini illimité, achat unique ' + (window.MONETIZATION||{}).priceLabel + ', sans abonnement ni publicité. Toutes les leçons, la théorie et le Coran restent gratuits.</p>' +
